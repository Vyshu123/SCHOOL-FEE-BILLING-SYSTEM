...
<head>
  ...
  <br>
   <div class="span3">
										<center>
										<img id="developers" src="images/vyshu.jpg" width="100px" height="100px" class="img-circle">
										<p>Name: Labhala Vyshnavi</p>
										<p>Address: 4-42-62, Asbestos Colony, Bal Nagar, Hyderabad, Telangana.</p>
										<p>Email: vyshu.labhala@gmail.com</p>
										<p>Position: Web Designer & Developer</p>
										</center>
								</div>
								<hr>
								<div class="span3">
										<center>
								        <img id="developers" src="images/kavya.jpg" width="100px" height="100px" class="img-circle">
                                        
                                        <p>Name: Kavya Bojja</p>
                                        <p>Address: 2/180, Teachers Colony, LakkiReddy Palli, Kadapa, Andhra Pradesh - 516527.</p>
                                        <p>Email: bojjakavya444@gmail.com</p>
                                        <p>Position: Web Designer & Developer</p>
								        </center>
								</div>
								<hr>
								 <div class="span3">
										<center>
										<img id="developers" src="images/kishore.jpg" width="100px" height="100px" class="img-circle">
                                        
                                        <p>Name: K V Kishore Reddy</p>
                                        <p>Address: 26-8-309, 3rd Street, VMR Nagar, Nellore, Andhra Pradesh - 524004.</p>
                                        <p>Email: kishorereddy0510@gmail.com</p>
                                        <p>Position: Web Designer & Developer</p>
										</center>
								</div>
								<br>
